...
virtual void OnEquipmentChanged_Implementation(ESlotType SlotType, int32 SlotIndex) override;
virtual void OnFittingStatsChanged_Implementation() override;

// ============================================================================
// EVENTS
// ============================================================================

UPROPERTY(BlueprintAssignable, Category = "Ship Stats|Events")
FSimpleMulticastDelegate OnStatsUpdated;
