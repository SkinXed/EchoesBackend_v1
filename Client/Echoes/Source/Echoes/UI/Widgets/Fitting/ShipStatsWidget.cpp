...
// Calculate average resistances across all layers (simplified)
// In real implementation, would calculate weighted average based on HP
...
OutAlpha = FittingData.TotalAlphaStrike;
...
void UShipStatsWidget::OnEquipmentChanged_Implementation(ESlotType SlotType, int32 SlotIndex)
{
// Called when equipment changes
ClientOnly_RefreshStats();
}

void UShipStatsWidget::OnFittingStatsChanged_Implementation()
{
