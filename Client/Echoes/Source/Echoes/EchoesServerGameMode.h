...
class UWorld; // forward declaration
...
public:
    ...
    /**
     * Helper to convert a TSoftObjectPtr<UWorld> to a package path usable by ClientTravel
     */
    FString GetMapPath(const TSoftObjectPtr<UWorld>& Map) const;
