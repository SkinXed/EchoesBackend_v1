...
#include "Echoes/Core/Common/Networking/EchoesIdentitySubsystem.h"
...
void FOnCharacterCreated_DelegateWrapper(const FScriptDelegate& OnCharacterCreated, FEchoesCharacter const& CharacterData)
{
	struct _Script_Echoes_eventOnCharacterCreated_Parms
	{
		FEchoesCharacter CharacterData;
	...
	Parms.CharacterData=CharacterData;
	OnCharacterCreated.ProcessDelegate<UObject>(&Parms);
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UEchoesIdentitySubsystem_Identity_GetSelectedCharacter_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(EchoesIdentitySubsystem_eventIdentity_GetSelectedCharacter_Parms, ReturnValue), Z_Construct_UScriptStruct_FEchoesCharacter, METADATA_PARAMS(0, nullptr) }; // 3920001638
...
DEFINE_FUNCTION(UEchoesIdentitySubsystem::execUI_CreateCharacter)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->UI_CreateCharacter(Z_Param_CharacterName,Z_Param_Race,Z_Param_PortraitId,FOnCharacterCreated(Z_Param_OnSuccess),FOnCharacterDataFailure(Z_Param_OnFailure));
	P_NATIVE_END;
}
...
struct Z_Construct_UClass_UEchoesIdentitySubsystem_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UEchoesIdentitySubsystem_Identity_FetchCharacter, "Identity_FetchCharacter" }, // 2715454894
		...
		{ &Z_Construct_UFunction_UEchoesIdentitySubsystem_UI_CreateCharacter, "UI_CreateCharacter" }, // 2090764714
	};
...
struct Z_CompiledInDeferFile_FID_Reposetory_EchoesBackend_v1_Client_Echoes_Source_Echoes_Core_Common_Networking_EchoesIdentitySubsystem_h__Script_Echoes_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEchoesIdentitySubsystem, UEchoesIdentitySubsystem::StaticClass, TEXT("UEchoesIdentitySubsystem"), &Z_Registration_Info_UClass_UEchoesIdentitySubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEchoesIdentitySubsystem), 2354246372U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Reposetory_EchoesBackend_v1_Client_Echoes_Source_Echoes_Core_Common_Networking_EchoesIdentitySubsystem_h__Script_Echoes_303290902(TEXT("/Script/Echoes"),
