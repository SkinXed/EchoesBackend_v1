    ...
    public partial class AddFactionsAndSkillGroups : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "{}", new DateTime(2026, 2, 5, 0, 0, 0, 0, DateTimeKind.Utc), "Arden faction", "Arden", new DateTime(2026, 2, 5, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 2, "{}", new DateTime(2026, 2, 5, 0, 0, 0, 0, DateTimeKind.Utc), "Nova faction", "Nova", new DateTime(2026, 2, 5, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 3, "{}", new DateTime(2026, 2, 5, 0, 0, 0, 0, DateTimeKind.Utc), "Solaris faction", "Solaris", new DateTime(2026, 2, 5, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 4, "{}", new DateTime(2026, 2, 5, 0, 0, 0, 0, DateTimeKind.Utc), "Valerion faction", "Valerion", new DateTime(2026, 2, 5, 0, 0, 0, 0, DateTimeKind.Utc) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_character_skills_enhanced_character_id_skill_id",
                table: "character_skills_enhanced",
                columns: new[] { "character_id", "skill_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_character_skills_enhanced_is_active_training_finished_at",
                table: "character_skills_enhanced",
                columns: new[] { "is_active", "training_finished_at" });
